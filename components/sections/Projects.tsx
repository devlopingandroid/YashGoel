          ...
          >
            <Card className="p-0 overflow-hidden bg-dark-surface/90 border-dark-border hover:border-accent-teal/40 hover:-translate-y-1.5 hover:shadow-teal-glow transition-all duration-300 flex flex-col justify-between h-full group">
              <div>
                ...
                <div className="relative aspect-video bg-dark-bg overflow-hidden border-b border-dark-border">
                ...
                {/* Card Content Body */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-primary group-hover:text-accent-teal transition-colors mb-2">
                    {project.title}
                  </h3>
