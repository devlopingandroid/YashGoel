...
export const galleryData: GalleryItem[] = [
  ...
  {
    id: "gal-intern-drdo",
    title: "DRDO Research Internship Certificate",
    category: "Internship",
    image: "/certificates/drdo-internship.jpg",
    caption: "Official Research Internship Completion & Excellence Certificate from DRDO SSPL.",
    spanClass: "md:col-span-2 md:row-span-1",
  },
  {
    id: "gal-intern-lab",
    title: "DRDO Solid State Physics Lab",
    category: "Internship",
    image: "/gallery/drdo-lab.jpg",
    caption: "Working on signal processing & research algorithms at DRDO research facility.",
    spanClass: "md:col-span-1 md:row-span-1",
  },
  {
    id: "gal-cert-sih",
  ...
  },
  {
    ...
    caption: "Engaging in sessions and developer meetups during the annual tech conference.",
    spanClass: "md:col-span-1 md:row-span-1",
  },
  {
    id: "gal-7",
